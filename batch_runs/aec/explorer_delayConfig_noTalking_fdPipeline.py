...
CASE_STUDY = "test_delayConfigs_fdPipeline_explorer"
...
test_params = {
    ...
    #"delayCfg" : [-5, 10, -10, 20, -20, 2, -2, 1, -1, 15, -15, 50, -50, 100, -100],
    "delayCfg" : [-44, -45, -46, -47 ],
}
...
import itertools
import time
from orbit.builder.xmos import build_firmware, usb_dfu_upload
...
def run_test_cases():
    ...
    for test_case in test_cases:
        ...
        variant = "example_ffva_ua_dev_fixed_delay"
        build_dir = f"build_{CASE_STUDY}"
        build_firmware( 
            build_dir=build_dir,
            src_dir=Path("/Users/mischa/Projects/FutureProofHomes/sln_voice"),
            variant=f"create_upgrade_img_{variant}",
            clean=True,
            defines=cmake_defines
        )
        
        target = Path("/Users/mischa/Projects/FutureProofHomes/sln_voice") / build_dir / f"{variant}_upgrade.bin"
