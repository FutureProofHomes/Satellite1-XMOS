...
static control_cmd_info_t dfu_controller_servicer_resid_cmd_map[] =
{
    ...
    { DFU_CONTROLLER_SERVICER_RESID_DFU_GETFLASHSERIAL, 8, sizeof(uint8_t), CMD_READ_ONLY },
    { DFU_CONTROLLER_SERVICER_RESID_DFU_GETIMAGESTATUS, 1, sizeof(uint8_t), CMD_READ_ONLY },
};
