...
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_FRAMES  (10)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_STREAMS  (2)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_SAMPLES_PER_FRAME (240)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_FRAME_META_BYTES (56)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_CHUNK_DATA_BYTES (224)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_SAMPLE_BYTES \
    (AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_FRAMES * \
     ...
     sizeof(int32_t))
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_META_BYTES \
    (AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_FRAMES * \
     AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_FRAME_META_BYTES)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_TOTAL_BYTES \
    (AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_SAMPLE_BYTES + \
     AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_META_BYTES)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_CHUNKS \
    ((AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_TOTAL_BYTES + \
      AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_CHUNK_DATA_BYTES - 1) / \
     AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_CHUNK_DATA_BYTES)
#define AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_MAGIC (0x41474343u) /* AGCC */
...
typedef struct
{
    ...
    uint8_t state;
    uint8_t reserved;
} fixed_delay_agc_capture_status_t;

typedef struct
{
    uint16_t chunk_index;
    uint16_t reserved;
} fixed_delay_agc_capture_chunk_select_t;
...
typedef struct
{
    ...
    uint8_t valid_bytes;
    uint8_t reserved;
    uint8_t data[AUDIO_PIPELINE_FIXED_DELAY_AGC_CAPTURE_CHUNK_DATA_BYTES];
} fixed_delay_agc_capture_chunk_t;
...
typedef struct
{
    ...
    int32_t x_peak_mant;
    int32_t x_peak_exp;
} fixed_delay_agc_capture_frame_meta_t;
...
typedef struct
{
    ...
    uint32_t sample_bytes;
    uint32_t meta_bytes;
} fixed_delay_agc_capture_probe_t;
#endif
