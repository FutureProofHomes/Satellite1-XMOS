...
static bool audio_pipeline_upsample_channel_index_is_valid(uint8_t channel_index)
{
    return audio_pipeline_output_channel_index_is_valid(channel_index) ||
           channel_index == AUDIO_PIPELINE_OUTPUT_VIRTUAL_SYNC_CHANNEL;
}
